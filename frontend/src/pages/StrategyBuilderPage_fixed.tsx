  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const payload = editingStrategyId 
        ? { ...strategy, strategy_id: editingStrategyId }
        : strategy;
                  ...
                  <div key={condition.id} className="condition-card">
                    <div className="condition-row">
                      ...
                      <div className="value-input-container">
                        <select
                          value={typeof condition.value === 'string' && hasIndicatorPattern(condition.value, "MA(") ? 'indicator' : 
                        ...
                        {(typeof condition.value === 'number' || 
                          (typeof condition.value === 'string' && !['close', 'open', 'high', 'low'].includes(condition.value) && !hasIndicatorPattern(condition.value, "MA("))) && (
                          <input
                            type="number"
                        ...
                        {/* 지표 입력 */}
                        {typeof condition.value === 'string' && hasIndicatorPattern(condition.value, "MA(") && (
                          <div style={{ display: 'flex', gap: '4px', alignItems: 'center' }}>
                            <select
                              value={hasIndicatorPattern(condition.value, "MA(") ? 'MA' : 
                                     hasIndicatorPattern(condition.value, "EMA(") ? 'EMA' :
                            ...
                            {!hasIndicatorPattern(condition.value, "MACD") && (
                              <>
                                <span>(</span>
                                <input
                                  type="number"
